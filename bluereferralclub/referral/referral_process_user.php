...
$stmt->bind_param(
    "ssssssssss",  // <- todos como string (último também)
    $referred,
    $referred_last_name,
    $referred_by,
    $referral_code,
    ...
    $mobile,
    $postcode,
    $client_type,      // << este aqui é string, estava como inteiro!
    $more_details,
    $user_id           // mesmo que seja int, o MySQL converte automaticamente
);
